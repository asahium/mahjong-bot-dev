#!/usr/bin/env python3
"""
PPO Training Script for MCR Mahjong

Train a PPO agent to play MCR Mahjong against random/greedy opponents.
...
from agents.sb3_agent import SB3Agent, create_mahjong_ppo, MahjongFeaturesExtractor
...
class WandbCallback(BaseCallback):
    ...
    def _on_training_end(self) -> None:
        ...
        if self.episode_rewards:
            ...
            wandb.run.summary["final/total_score"] = self.total_score
...
def train_ppo(
    ...
    """
    Train a PPO agent for MCR Mahjong.
    """
    # Create save directory
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    run_name = wandb_run_name or f"ppo_{timestamp}"
    ...
    print("=" * 60)
    print("MCR Mahjong PPO Training")
    print("=" * 60)
...
def main():
    parser = argparse.ArgumentParser(description="Train PPO agent for MCR Mahjong")
    ...
    parser.add_argument("--n-steps", type=int, default=2048,
                       help="Steps per update per environment")
